...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("C1.Android.Core.LayoutChangeListener, C1.Android.Core", LayoutChangeListener.class, __md_methods);
	}
	...
	public LayoutChangeListener ()
	{
		...
		if (getClass () == LayoutChangeListener.class)
			mono.android.TypeManager.Activate ("C1.Android.Core.LayoutChangeListener, C1.Android.Core", "", this, new java.lang.Object[] {  });
	}
